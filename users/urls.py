...
from .views import (InfluencerSignupView,
 ...
 CustomAuthToken, LogoutView, BrandOnlyView, InfluenecerOnlyView, EmployeeOnlyView)
...
urlpatterns=[
    ...
    path('influencer/dashboard/', InfluenecerOnlyView.as_view(), name='influencer-dashboard'),
